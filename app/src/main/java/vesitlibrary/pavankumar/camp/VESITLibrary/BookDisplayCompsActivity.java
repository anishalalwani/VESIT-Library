...
public class BookDisplayCompsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GET PASSED DATA
        Intent i=getIntent();
        pos=i.getExtras().getInt("idbycomps");
        //GET VIEWS
        final BookDisplayComps adapter=new BookDisplayComps();
        passbooknamecount = (TextView) findViewById(R.id.passbooknamecount);
        id = Integer.parseInt(adapter.compsbkid[pos]);
        idauth = Integer.parseInt(adapter.compsauthid[pos]);
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (isConnected) {
            ...
            color = Color.WHITE;
            final ProgressDialog progressDialog = new ProgressDialog(BookDisplayCompsActivity.this,
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(BookDisplayCompsActivity.this, "Server is busy \nPlease Try Again Later :/",Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
        ...
        sbView.setBackgroundColor(ContextCompat.getColor(BookDisplayCompsActivity.this, R.color.snackbar2));

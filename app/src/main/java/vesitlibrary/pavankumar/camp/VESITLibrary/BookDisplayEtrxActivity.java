...
public class BookDisplayEtrxActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GET PASSED DATA
        Intent i=getIntent();
        pos=i.getExtras().getInt("idbyetrx");
        //GET VIEWS
        final BookDisplayEtrx adapter = new BookDisplayEtrx();
        passbooknamecount = (TextView) findViewById(R.id.passbooknamecount);
        checknet =  (TextView)findViewById(R.id.checknet);

        id = Integer.parseInt(adapter.etrxbkid[pos]);
        idauth = Integer.parseInt(adapter.etrxauthid[pos]);
        checkConnection();
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (isConnected) {
            ...
            color = Color.WHITE;
            final ProgressDialog progressDialog = new ProgressDialog(BookDisplayEtrxActivity.this,
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(BookDisplayEtrxActivity.this, "Server is busy \nPlease Try Again Later :/",Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
        ...
        sbView.setBackgroundColor(ContextCompat.getColor(BookDisplayEtrxActivity.this, R.color.snackbar2));

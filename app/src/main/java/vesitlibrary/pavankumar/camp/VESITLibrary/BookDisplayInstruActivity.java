...
public class BookDisplayInstruActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GET PASSED DATA
        Intent i=getIntent();
        pos=i.getExtras().getInt("idbyinstru");
        //GET VIEWS
        final BookDisplayInstru adapter=new BookDisplayInstru();

        passbooknamecount = (TextView) findViewById(R.id.passbooknamecount);
        checknet =  (TextView)findViewById(R.id.checknet);

        id = Integer.parseInt(adapter.instrubkid[pos]);
        idauth = Integer.parseInt(adapter.instruauthid[pos]);
        checkConnection();
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (isConnected) {
            ...
            color = Color.WHITE;
            final ProgressDialog progressDialog = new ProgressDialog(BookDisplayInstruActivity.this,
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(BookDisplayInstruActivity.this,"Server is busy \nPlease Try Again Later :/",Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
        ...
        sbView.setBackgroundColor(ContextCompat.getColor(BookDisplayInstruActivity.this, R.color.snackbar2));
